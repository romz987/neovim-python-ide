...
**Что именно конфигурируется в chadrc.lua? Краткий обзор**

Вприницпе, справочный материал дает исчерпывающую информацию по возможностям конфигурации.\
...
После этого, согласно документации NvChad, необходимо выполнить :Lazy sync.
...
А потом, для корректной работы nvim-treesitter c Python следует перезапустить Neovim.
